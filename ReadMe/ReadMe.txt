Objective of the Code: The .py files each contain a different bot strategy. Six of the bots are
...
How to Run the Code: The team used the bash1.sh file to run the matches. In that file, four bots are specified 
